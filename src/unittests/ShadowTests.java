...
public class ShadowTests {
	...
	public void SphereTriangleInitial() {
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0), new Vector(1, -1, 3),new Point3D(-100, 100, -200), 1, 1E-5, 1.5E-7,10));
	...
	public void SphereTriangleSpot1() {
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0),new Vector(1, -1, 3), new Point3D(-85, 85, -130),  1, 1E-5, 1.5E-7,10));
	...
	public void SphereTriangleSpot2() {
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0),new Vector(1, -1, 3),new Point3D(-74, 74, -62),  1, 1E-5, 1.5E-7,10));
