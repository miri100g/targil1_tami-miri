...
public class LightsTests {
    ...
    public void spherePoint() {
        ...
        scene.addLights(new PointLight(new Color(500, 300, 0), new Point3D(-50, 50, -50), 1, 0.00001, 0.000001,10));
    ...
    public void sphereSpot() {
        ...
        scene.addLights(new SpotLight(new Color(500, 300, 0), new Vector(1, -1, 2),new Point3D(-50, 50, -50), 1, 0.00001, 0.00000001,10));
    ...
    public void sphereLights() {
        ...
        scene.addLights(new SpotLight(new Color(500, 300, 0), new Vector(1, -1, 2),new Point3D(-50, 60, -50), 1, 0.001, 0.0001,10),
        		new PointLight(new Color(500, 300, 0), new Point3D(150, -200, -50), 1, 0.00001, 0.000001,10),
    ...
    public void trianglesSpot() {
        ...
        scene.addLights(new SpotLight(new Color(500, 250, 250), new Vector(-2, 2, 1), new Point3D(10, 10, 130),1, 0.0001, 0.000005,10));
    ...
    public void trianglesLights() {
        ...
        scene.addLights(new SpotLight(new Color(500, 250, 250), new Vector(-2, 2, 1), new Point3D(50, 50, 130),1, 0.0001, 0.000005,10),
        		new PointLight(new Color(500, 250, 250),new Point3D(8, 3, 100),1, 0.000005, 0.0005,10),
