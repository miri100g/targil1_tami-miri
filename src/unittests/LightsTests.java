...
public class LightsTests {
    ...
    public void sphereSpot() {
        ...
        scene.addLights(new SpotLight(new Color(500, 300, 0), new Vector(1, -1, 2),new Point3D(-50, 50, -50), 1, 0.00001, 0.00000001));
    ...
    public void sphereLights() {
        ...
        scene.addLights(new SpotLight(new Color(500, 300, 0), new Vector(1, -1, 2),new Point3D(-50, 60, -50), 1, 0.001, 0.0001),
    ...
    public void trianglesSpot() {
        ...
        scene.addLights(new SpotLight(new Color(500, 250, 250), new Vector(-2, 2, 1), new Point3D(10, 10, 130),1, 0.0001, 0.000005));
    ...
    public void trianglesLights() {
        ...
        scene.addLights(new SpotLight(new Color(500, 250, 250), new Vector(-2, 2, 1), new Point3D(50, 50, 130),1, 0.0001, 0.000005),
